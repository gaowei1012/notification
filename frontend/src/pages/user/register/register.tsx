    ...
    <SafeAreaView style={styles.registerCotainer}>
      ...
      <View style={styles.textInputWrap}>
        ...
        <View style={styles.textInputBox}>
          ...
          />
          <TouchableOpacity style={styles.sendCode} activeOpacity={1} onPress={() => {}} disabled={disabled}>
      ...
      <TouchableOpacity style={[styles.submitBox, isFocus ? styles.activeSubmitBox : null]} activeOpacity={1} onPress={() => {}}>
